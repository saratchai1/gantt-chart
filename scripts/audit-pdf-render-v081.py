...
ROOT = Path('data')
PAGES_DIR = ROOT / 'pdf-v081-pages'
REPORT_JSON = ROOT / 'pdf-render-audit-v081.json'
REPORT_MD = ROOT / 'pdf-render-audit-v081.md'
...
for sheet_index in range(math.ceil(len(page_paths) / (cols * rows))):
    ...
    output = ROOT / f'pdf-v081-contact-sheet-{sheet_index + 1:02d}.png'
...
md_lines = [
    '# PDF Raster Audit — ฉบับฐาน v0.8.1 ภาษาไทย',
    '',
